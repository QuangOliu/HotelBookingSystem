...
public class DBDataConfig {
    ...
    CommandLineRunner loadData(RoomRepository roomRepository, RoomTypeRepository roomTypeRepository, UserRepository userRepository,
        ...
        return args -> {
            ...
            User adminUser1 = new User("Quang", password, "trantran30102002@gmail.com", "5141111111", address, adminRole);
            User adminUser = new User("Nup", password, "nup@gmail.com", "5141111111", address, adminRole);
            User clientUser = new User("Duy", password, "duy@gmail.com", "5142222222", address, clientRole);
            User clientUser1 = new User("Dmitri", password, "user1@gmail.com", "5142222222", address, clientRole);
            User clientUser2 = new User("Lily", password, "user2@gmail.com", "5142222222", address, clientRole);
            User clientUser3 = new User("Alice", password, "user3@gmail.com", "5142222222", address, clientRole);
